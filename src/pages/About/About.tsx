  ...
  return (
    ...
    >
      <div className="about-content content-container padding-side-20">
        ...
        <p>
          I am a web developer skilled with various web technologies. I like to
          push myself beyond my limit to do something new and creative. I always
          keep myself up to date with the latest technologies and passionate to
          learn new things.
        </p>
        <p>
